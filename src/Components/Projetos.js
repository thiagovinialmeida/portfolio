    ...
    return(
        <>
            ...
            <h3 className="mt-40 text-violet-400 col-span-2 sm:col-span-4 text-3xl pl-5"> == Habilidades</h3>
                <div className="border-2 border-zinc-600 text-center m-5">
            ...
            <section className="mt-40 grid grid-cols-2 gap-5 sm:grid-cols-4">
    ...
    return (
        <>
                <div className="border-2 border-zinc-600 text-center m-5">
                    ...
                    <p className="text-yellow-200">Em breve</p> 
                </div>
        </>
    )
}